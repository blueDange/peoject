  ...
  var methods = {
    init: function (options) {
      ...
      return this.each(function () {
        ...
        if (!data) {
          ...
          $window.on(
            "load." + namespace + " pageshow." + namespace,
            function () {
    ...
    addLoading: function (options) {
      $(options.loadingParentElement).append(
        '<div class="' + options.loadingClass + '"></div>'
      );
    },
    ...
    pageIn: function () {
      ...
      var inDuration = methods.animationCheck.call(
        _this,
        thisInDuration,
        false,
        true
    ...
    pageOut: function ($self) {
      ...
      var outClass = methods.animationCheck.call(
        _this,
        isOutClass,
        true,
        false
      );
      var outDuration = methods.animationCheck.call(
        _this,
        isOutDuration,
        false,
        false
